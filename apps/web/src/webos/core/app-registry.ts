...
export const APP_REGISTRY: AppDefinition[] = [
  ...
  },
  {
    ...
    name: 'Lens',
    icon: '🌿',
    description: 'Lens Protocol config, profiles, GraphQL, Grove storage and cross-chain messaging',
    permissions: ['web3.read', 'web3.write'],
    defaultWidth: 1200,
    defaultHeight: 780,
    component: lazy(() => import('../apps/lens/LensApp')),
  },
  {
    id: 'friendpass-admin',
    name: 'FriendPass Admin',
    icon: '🎫',
    description: 'Configure FriendPass pricing, bonding curve, Polygon contract and simulations',
    permissions: ['web3.read', 'web3.write'],
    defaultWidth: 1100,
    defaultHeight: 720,
    component: lazy(() => import('../apps/friendpass-admin/FriendPassAdminApp')),
  },
  {
    id: 'graphql-designer',
    name: 'GraphQL Designer',
    icon: '🔷',
    description: 'Design and test GraphQL message types and templates for Lens integration',
    permissions: ['web3.read', 'web3.write'],
    defaultWidth: 1200,
    defaultHeight: 760,
    component: lazy(() => import('../apps/graphql-designer/GraphQLDesignerApp')),
  },
  {
    id: 'settings',
    name: 'Settings',
